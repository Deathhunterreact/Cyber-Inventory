...
RegisterNetEvent('cyber-inventory:useWeapon')
AddEventHandler('cyber-inventory:useWeapon', function(weapon)
...
RegisterNetEvent('cyber-inventory:removeCurrentWeapon')
AddEventHandler('cyber-inventory:removeCurrentWeapon', function()
...
function RemoveWeapon(weapon)
    ...
    TriggerServerEvent('cyber-inventory:updateAmmoCount', hash, ammoCount)
        ...
        if IsPedShooting(player) then
            for k, v in pairs(Config.Throwables) do
                if k == currentWeapon then
                    print('Taking Weapon')
                    ESX.TriggerServerCallback('cyber-inventory:takePlayerItem', function(removed)
                        if removed then
