ESX.RegisterServerCallback('cyber-inventory:UseItemFromSlot', function(source, cb, slot)
...
ESX.RegisterServerCallback('cyber-inventory:GetItemsInSlotsDisplay', function(source, cb)
    local player = ESX.GetPlayerFromId(source)
    InvType['player'].getInventory(player.identifier, function(inventory)
        local slotItems = {}
        for i = 1, 5, 1 do
...
RegisterServerEvent('cyber-inventory:printtext')
AddEventHandler('cyber-inventory:printtext', function(text)
    print(text)
end)