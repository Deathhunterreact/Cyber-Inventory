...
RegisterServerEvent('cyber-inventory:registerPeriodCron')
AddEventHandler('cyber-inventory:registerPeriodCron', function(cron, time)
    if cron == nil then
        cron = function()
...
RegisterServerEvent('cyber-inventory:registerTimeCron')
AddEventHandler('cyber-inventory:registerTimeCron', function(cron, time)
    local job = {}
